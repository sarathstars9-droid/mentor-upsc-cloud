    ...
    <div className="mpw-page">
      <main className="mpw-shell">
        <PremiumPaperHero
          ...
          subtitle="History, Society, Geography & Art and Culture — browse the paper, study PYQ patterns, and start focused answer writing."
          stats={[
        ...
        <section aria-labelledby="gs1-question-list-title">
          <div className="mpw-list-heading">
            <div>
              <div className="mpw-eyebrow">Question Library</div>
              <h2 id="gs1-question-list-title">{activeTheme === "all" ? "All GS1 Questions" : activeTheme}</h2>
            </div>
